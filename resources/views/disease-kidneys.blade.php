	                ...
	                <div class="zabs-body">
	                  ...
	                  <div class="last-questions">
	                    <div class="question"><a class="question__name" href="{{ url('/Pagec/view/name/pielonefrit') }}">Пиелонефрит</a>
							<p class="question__text">В случаях, когда заболевание развивается в совершенно здоровой ничем не скомпрометированной почке, пиелонефрит называют первичным. Хронический пиелонефрит чаще всего бывает вторичным.<br> <span class="pielo-inner">При обострении хронического пиелонефрита проявления могут быть невыраженными, скрытыми настолько, что больной не обращает внимания.</span> Одним из основных критериев для постановки диагноза являются лабораторные методы исследования. Если вы подозреваете у себя наличие пиелонефрита, не занимайтесь самолечением во избежание усугубления ситуации, обратитесь к специалисту.
	                      </p>
	                    </div>
	                  </div>
	                </div>
