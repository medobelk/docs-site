  ...
  <div class="header-patient__container header__container">
          ...
          <div class="mobile-menu__links hide">
              <div class="flex-block">
                  <div class="links-block">
                      <a class="header-nav__link mobile-menu__link" href="medical-history.html">история болезни</a>
                      <a class="header-nav__link mobile-menu__link" href="add-question.html">задать вопрос</a>
                      <a class="header-nav__link mobile-menu__link" href="visite-create.html">записать на приём</a>
                      ...
                      <a class="header-nav__link mobile-menu__link control-buttons__reviews-add" href="#">оставить отзыв</a>
                  </div>
    ...
    <div class="header-patient__nav">
      <nav class="header-nav">
          <a class="header-nav__link" href="medical-history.html">история болезни</a>
          <a class="header-nav__link" href="add-question.html">задать вопрос</a>
          <a class="header-nav__link" href="visite-create.html">записать на приём</a>
      </nav>
    </div>
