<footer>
  <div class="footer-body">
    ...
    <div class="footer-item three">
      ...
      <a href="{{ url('/Pagec/view/name/methods') }}"><p class="footer-item__review info">Один из новых немедикаментозных методов лечения. Использую при лечении хронических цистита, пиелонефрита, других заболеваний. Уже после 2х процедур пациенты отмечают значительное улучшение состояния. Метод предполагает введение  обогащенной тромбоцитами плазмы самого больного.
      </p></a>
    </div>
  </div>
