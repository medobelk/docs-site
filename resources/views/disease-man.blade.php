                  ...
                  <div class="zabs-list__zabs">
                    <div class="zabs-body">
                      ...
                      <div class="last-questions">
                        <div class="question"><a class="question__name" href="{{ url('/Pagec/view/name/prostatit') }}">Простатит</a>
                        ...
                        <div class="question"><a class="question__name" href="{{ url('/Pagec/view/name/erect-disfunction') }}">Эректильная дисфункция</a>
                        ...
                        <div class="question"><a class="question__name" href="{{ url('/Pagec/view/name/obrezanie') }}">Обрезание</a>
                        ...
                        <div class="question"><a class="question__name" href="{{ url('/Pagec/view/name/varicocele') }}">Варикоцеле</a>
                          <p class="question__text">Варикоцеле (расширение вен яичка) - расширение вен гроздьевидного сплетения семенного канатика в связи с нарушением оттока крови по этим венам. Варикоцеле чаще всего протекает без симптомов, иногда возникают боли разной выраженности и локализации, часто с противоположной стороны. Боли могут возникать после длительной физической нагрузки, полового акта, длительного сидения или стояния.
                          </p>
                        </div>
                      </div>
                    </div>
