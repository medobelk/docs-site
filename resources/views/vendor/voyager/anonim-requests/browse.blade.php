                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endcan
                                            @can('edit', $data)
                                                <a data-toggle="popover" data-placement="top" class="btn btn-sm btn-success pull-right edit accept-enroll" data-id="{{ $data->{$data->getKeyName()} }}" id="accept-{{ $data->{$data->getKeyName()} }}">
                                                    <i class="voyager-check"></i> <span class="hidden-xs hidden-sm">Записать</span>
                                                </a>
                                            @endcan
                                            @can('read', $data)
                                                <a href="{{ route('voyager.'.$dataType->slug.'.show', $data->{$data->getKeyName()}) }}" title="{{ __('voyager.generic.view') }}" class="btn btn-sm btn-warning pull-right" data-id="{{ $data->{$data->getKeyName()} }}" id="delete-{{ $data->{$data->getKeyName()} }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="{{ __('voyager.generic.close') }}"><span
                                aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="voyager-check"></i> Все верно Вы уверены? </h4>
                </div>
                <div class="modal-footer">
                    <form action="{{ url('admin-cus/enroll-accept') }}" id="form-accept-enroll" method="POST">
                        {{ csrf_field() }}
...
@section('javascript')
    ...
    <script>
        ...
        $('td').on('click', '.accept-enroll', function (e) {
            var form = $('#form-accept-enroll')[0];
    ...
    @include('voyager_custom.calendar')
@stop
