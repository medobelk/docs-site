...
@section('javascript')
    ...
    <script>
        ...
        $('document').ready(function () {
            ...
            var dateParent = $('.datepicker').parent();
            $('.datepicker').each(function () {
                $(this).remove();
            });
            dateParent.each(function () {
                $(this).append('<input class="form-control newDateTime" type="text" >');
            });  
            ...
            $("label:contains('Control Visit')").text('Котрольный Визит');
        });
    </script>
@stop
