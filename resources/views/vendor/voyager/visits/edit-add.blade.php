...
@section('javascript')
    ...
    @include('voyager_custom.date-time-admin')
    ...
    <script>
        ...
        $('document').ready(function () {
            ...
            //CUSTOME DATETIME
            var dateParent = $('.datepicker').parent()[0];
            $('.datepicker').remove();
            $(dateParent).append('<input class="form-control newDateTime" type="text" >');
            ...
            $('[data-toggle="tooltip"]').tooltip();
                ...
                $("label:contains('Complaints')").text('Жалобы');
                $("label:contains('Treatment')").text('Лечение');
                $("label:contains('Recomendations')").text('Рекомендации');
                $("label:contains('Diagnosis')").text('Дигноз');
                $("label:contains('Visit Date')").text('Дата Визита');
                $("label:contains('Status')").text('Статус');
        });
    </script>
@stop
